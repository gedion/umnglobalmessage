...
/**
 *
 * This script will initiate the admin view.
...
class umnglobalmessage_admin implements umnglobalmessage_view {
    /**
    ...
    public function get_row($data) {
        ...
        $popup = $data->popup ? get_string('popup_table', 'local_umnglobalmessage') : get_string('banner', 'local_umnglobalmessage');
    ...
    private function get_message_buttons($id) {
        ...
        $edit = html_writer::link(new moodle_url('/local/umnglobalmessage/ajax_local_umnglobalmessage.php',
                                  array('action' => 'edit',
                                        'id' => $id)), $editimage);
